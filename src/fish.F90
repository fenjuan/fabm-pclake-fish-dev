...
!   Fen: testing vertical movement of zooplanktivorous fish
     real(rk)    :: vfish
...
!  the user defined minumun value for state variables
   ...
   call self%get_parameter(self%vfish,       'vfish',       'm/d',   'daily average fish vertical movement',                                     default=0.0001_rk,scale_factor=1.0_rk/secs_pr_day)
...
!BOP
   ...
   _SET_VERTICAL_MOVEMENT_(self%id_sDFiJv,self%vfish)
   _SET_VERTICAL_MOVEMENT_(self%id_sDFiAd,self%vfish)
